...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["evan@mergington.edu", "mia@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Develop soccer tactics and fitness through drills and scrimmages",
    ...
    "School Band": {
        "description": "Practice musical pieces and perform at school events",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
    ...
    "Science Club": {
        "description": "Explore experiments, science news, and STEM challenges",
